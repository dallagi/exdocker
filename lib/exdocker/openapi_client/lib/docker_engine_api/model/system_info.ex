...
defmodule DockerEngineAPI.Model.SystemInfo do
  ...
  @type t :: %__MODULE__{
    ...
    :ClusterStore => String.t | nil,
    :ClusterAdvertise => String.t | nil,
...
defimpl Poison.Decoder, for: DockerEngineAPI.Model.SystemInfo do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:DefaultAddressPools, :list, DockerEngineAPI.Model.SystemInfoDefaultAddressPoolsInner, options)
  end
end
