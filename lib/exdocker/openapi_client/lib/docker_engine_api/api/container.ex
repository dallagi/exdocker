...
defmodule DockerEngineAPI.Api.Container do
  ...
  - `{:ok, [%ContainerChangeResponseItem{}, ...]}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec container_changes(Tesla.Env.client, String.t, keyword()) :: {:ok, list(DockerEngineAPI.Model.ContainerChangeResponseItem.t)} | {:ok, DockerEngineAPI.Model.ErrorResponse.t} | {:error, Tesla.Env.t}
  def container_changes(connection, id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%DockerEngineAPI.Model.ContainerChangeResponseItem{}]},
      {404, %DockerEngineAPI.Model.ErrorResponse{}},
      {500, %DockerEngineAPI.Model.ErrorResponse{}}
    ])
  end
